...
- **Armor**: none
- **Weapons**: simple, [shortswords](shortsword.md)
...
You gain the following benefits while you are unarmed or wielding only monk weapons and you aren't wearing armor or wielding a [shield](dnd5e-markdown-main/compendium/items/shield.md).
