...
- A [shield](dnd5e-markdown-main/compendium/items/shield.md) and a holy symbol  
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](dnd5e-markdown-main/compendium/backgrounds/acolyte.md) background.
